...
library RevnetCoreDeploymentLib {
        ...
        returns (RevnetCoreDeployment memory deployment)
    {
        deployment.basic_deployer =
            IREVDeployer(_getDeploymentAddress(path, "revnet-core-v5", network_name, "REVDeployer"));

        deployment.loans = IREVLoans(_getDeploymentAddress(path, "revnet-core-v5", network_name, "REVLoans"));
    }
